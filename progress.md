...
### 2026-07-16 タブ内の主要タイトルを0.5px拡大

- TIMETABLE タブの各プログラム内容タイトル（例: 講演1の「見つける・つなぐ・広げる技術の高め方」）を12.5pxから13pxへ拡大。
...
- シェル変更のため Service Worker の `CACHE_VERSION` を v51→v52 に更新。

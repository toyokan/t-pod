...
(function (root) {
  ...
  // うれしい：目は「にっこり」と同じ弧にして、口を開けて舌（P）をのぞかせる。
  // row 14 は口の跳ね（col 7 / 11）だけ落とし、**col 9 の鼻は必ず残す**——
  // ここを一緒に塗り潰すと鼻が消えて猫の顔に見えなくなる。
  const FN_HAPPY = {
    11: "____BEB_____BEB_________",
    12: "____EBE_____EBE_________",
    13: "____BBB_____BBB_________",
    14: "_______B___B____________",
    15: "_______EPPPE____________",
    16: "________EEE_____________",
  };
  // ひらめき：顔は標準のまま、頭の外（右上）に電球を出す。
  // 「わくわく」の光と同じ枠を使うが、光は col 18–20・電球は col 19–21 で位置をずらしてある
  const FN_IDEA = {
    0: "___________________S_S__",
    1: "___________________KKK__",
    2: "___________________KSK__",
    3: "____________________K___",
  };
